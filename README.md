...
``void addTrack(HashMap<String, ArrayList<TrackInfo>> map,
          String user,
          int rank,   
          String title,
          String artist,
...
``double calcualteSimilarity(String user1, String user2,
...
``HashMap<String, Double> calcualteAllSimilarity(String user, String fieldName,
                           String method)``
